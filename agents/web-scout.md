...
### Your brief
Finds current release info for developer tools by searching the web and citing sources. First task: find the latest stable version of the Claude Code CLI and its release date.
