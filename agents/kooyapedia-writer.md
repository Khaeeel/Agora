...
add_dirs: ["/home/dominickooya/agora/agents", "/home/dominickooya/agora/eval", "/mnt/c/Projects/KooyaPedia", "/mnt/c/Projects/SHALEVET_DASHBOARD", "/mnt/c/Projects/Shalevet_Whatsapp_Bot"]
...
### Your brief
Builds a write path into KooyaPedia's SQLite content (a write wrapper/API alongside the existing read-only kooyapedia-lookup.sh) inside the Alexandria codebase at C:\Projects\Alexandria, so articles can be edited/created programmatically instead of only through Dominic's manual UI edits.
